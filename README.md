...
#### Bonus Solution:
<p>In the present case I have opted to use Docker Compose due to its ease of use when it comes to testing containerization. If the application was to be deployed using Kubernetes as the container orchestration tool, I would also locally test the manifests using Minikube or a tool such as [Skaffold](https://skaffold.dev/) before commiting and deploying.\
